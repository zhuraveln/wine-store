...
const SkeletonWineCard: React.FC = () => (
  ...
  >
    ...
    <rect x="123" y="55" rx="0" ry="0" width="27" height="46" /> {/* wineglass */}
    <rect x="120" y="89" rx="23" ry="23" width="30" height="29" /> {/* wineglass */}
    <rect x="133" y="111" rx="0" ry="0" width="6" height="67" /> {/* leg wineglass */}
    <rect x="126" y="170" rx="18" ry="18" width="21" height="9" /> {/* bottom wineglass */}
    <rect x="42" y="188" rx="10" ry="10" width="195" height="24" /> {/* title */}
  </ContentLoader>
);
